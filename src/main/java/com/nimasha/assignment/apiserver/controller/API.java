package com.nimasha.assignment.apiserver.controller;

import com.nimasha.assignment.apiserver.model.StateData;
...
public class API {
    ...
    public ResponseEntity<Object> codeToState(@RequestParam String code) {
    ...
    public ResponseEntity<Object> stateToCode(@RequestParam String state) {
        Map<String, String> uriVariables = new HashMap<>();
